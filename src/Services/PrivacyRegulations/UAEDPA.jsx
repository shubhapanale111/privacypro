  ...
  return (
    ...
    <div className="uaefirstrow">
                <div className="uaefirstrowcol">
                  <h1><center className='hippamaintitle'>UAE Data Privacy Act (PhilippinesDPA)</center></h1>
    ...
    <div className="uaefourthrow">
                  ...
                  <div className="uaefourthrowcol2">
                    <h3>
                      <center style={{ paddingTop: '20px', fontSize: '30px',marginTop:'-10vh' }}>Why Is Philippines DPA Compliance Necessary for Your Organization?</center>
                    </h3>
                    <p style={{ color: 'black' }}>
                    <ul>
                          <li>
